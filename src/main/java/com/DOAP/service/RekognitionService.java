...
public class RekognitionService {
        ...
        public List<ModerationLabel> detectModerationLabels(String bucketName, String key) {
                System.out.println("\n\n\n\n\n\n\n\n\n\n\n\nModeration labels: " + bucketName + ", " + key);            
                S3Object s3Object = S3Object.builder()
                                .bucket(bucketName)
                                .name(key)
                                .build();
              System.out.println("\n\n\n\n\n\n\n\n\n\n\n\nModeration labels: " + s3Object);          

                Image image = Image.builder()
                                .s3Object(s3Object)
                                .build();
                System.out.println("\n\n\n\n\n\n\n\n\n\n\n\nModeration labels: " + image);          
        ...
        DetectFacesResponse response = rekognitionClient.detectFaces(request);
                System.out.println("\n\n\n\n\n\n\n responce detect face labels: " + response);          
        ...
        DetectTextResponse response = rekognitionClient.detectText(request);
                System.out.println("\n\n\n\n\n responce detect text labels: " + response);          
        ...
        public List<Label> detectLabels(String bucketName, String key) {
                ...
                System.out.println("\n\n\n\n responce detect labels: " + response);          
